...
////
////	public void createStreamingConnection(String baseUrl){
////		
////		HttpClient httpClient=new DefaultHttpClient();
////		httpClient.getParams().setParameter("CONNECTION_TIMEOUT" ,new Integer(90000));
////		
////		OAuthConsumer consumer= new CommonsHttpOAuthConsumer("saumi89@gmail.com","");
////		
////		
////		
////	}
...
//					 JSONObject jo = new JSONObject(EntityUtils.toString(response2.getEntity()));
//					 System.out.println("got in before");
//					 if(jo.has("errors"))
//					 {
//						 System.out.println("got in elifse");
//						 jsonresponse.put("response_status", "error");
//						 String message_from_twitter = jo.getJSONArray("errors").getJSONObject(0).getString("message");
//						 if(message_from_twitter.equals("Invalid or expired token") || message_from_twitter.equals("Could not authenticate you"))
//							 jsonresponse.put("message", "Twitter auth error.");
...
//		JSONObject a=twitter.searchTweets("Chris Christie", "82623281-5WGmk6LVgs33ANlbvrqDSFhwKVbM2ST3JLuUP6SCf", "KBn2u4l34dSDYNuoNr8ktC61jUuOyvzrBJnCCumqgfhHl");
//		//a.
//		//JSONObject a=twitter.getTweet("82623281-5WGmk6LVgs33ANlbvrqDSFhwKVbM2ST3JLuUP6SCf", "KBn2u4l34dSDYNuoNr8ktC61jUuOyvzrBJnCCumqgfhHl","Chris Christie");
